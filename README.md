...
Para que os identificadores sejam unívocos, seus valores provirão de um contador do tipo **```int```** será adicionado no início do arquivo com o fim de ser lido e incrementado a cada inserção.
